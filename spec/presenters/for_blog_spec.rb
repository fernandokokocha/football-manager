...
#       @left_tackle_1 = Player.new(position: "LT", name: "Lew Pierwszy")
#       @roster_1 = Roster.new(team: @team_1, kicker: @kicker_1, qb: @qb_1, center: @center_1, returner: @returner_1, left_tackle: @left_tackle_1)
...
#       @left_tackle_2 = Player.new(position: "LT", name: "Lew Drugi")
#       @roster_2 = Roster.new(team: @team_2, kicker: @kicker_2, qb: @qb_2, center: @center_2, returner: @returner_2, left_tackle: @left_tackle_2)
...
#         run: SkillBasedRunPhaseGenerator.new,
#       })
